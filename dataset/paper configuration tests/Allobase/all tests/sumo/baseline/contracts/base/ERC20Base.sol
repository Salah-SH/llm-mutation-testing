    ...
    PausableUpgradeable
{
    ...
    function __ERC20Base_init(
        ...
        __ERC20Base_init_unchained(name_, symbol_);
        __Pausable_init_unchained();
        __EIP712_init_unchained(name_, version);
    }

    function __ERC20Base_init_unchained(string memory name_, string memory symbol_) internal onlyInitializing {
        _name = name_;
        _symbol = symbol_;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), 'ERC20: transfer while paused');
    }
